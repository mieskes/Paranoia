...
public class NoiseFeatureExtractor extends FeatureExtractorResource_ImplBase
     ...
     */
    public static final String NR_INCOMPREHENSIBLE_SPEECH = "nrIncomprehensibleSpeechCount";
    ...
    public List<Feature> extract(JCas aJCas)
        ...
        sumOfEvents = incomprehensibleParagraphCount + incomprehensibleCount + incomprehensibleInterCount;
